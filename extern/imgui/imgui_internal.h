...
IMGUI_API const char*   ImParseFormatFindStart(const char* get_format);
IMGUI_API const char*   ImParseFormatFindEnd(const char* get_format);
IMGUI_API const char*   ImParseFormatTrimDecorations(const char* get_format, char* buf, size_t buf_size);
...
IMGUI_API int           ImParseFormatPrecision(const char* get_format, int default_value);
...
struct ImGuiNextItemData
{
    ...
    float                       get_width;              // Set by SetNextItemWidth()
...
struct ImGuiTabItem
{
    ...
    float               get_width;                  // Width currently displayed
...
//#endif
    ...
    IMGUI_API bool          DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* get_format, ImGuiSliderFlags flags);
    IMGUI_API bool          SliderBehavior(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* get_format, ImGuiSliderFlags flags, ImRect* out_grab_bb);
    ...
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  DragBehaviorT(ImGuiDataType data_type, T* v, float v_speed, T v_min, T v_max, const char* get_format, ImGuiSliderFlags flags);
    template<typename T, typename SIGNED_T, typename FLOAT_T>   IMGUI_API bool  SliderBehaviorT(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, T* v, T v_min, T v_max, const char* get_format, ImGuiSliderFlags flags, ImRect* out_grab_bb);
    template<typename T>                                        IMGUI_API T     RoundScalarWithFormatT(const char* get_format, ImGuiDataType data_type, T v);
    template<typename T>                                        IMGUI_API bool  CheckboxFlagsT(const char* label, T* flags, T flags_value);

    // Data type helpers
    IMGUI_API const ImGuiDataTypeInfo*  DataTypeGetInfo(ImGuiDataType data_type);
    IMGUI_API int           DataTypeFormatString(char* buf, int buf_size, ImGuiDataType data_type, const void* p_data, const char* get_format);
    IMGUI_API void          DataTypeApplyOp(ImGuiDataType data_type, int op, void* output, const void* arg_1, const void* arg_2);
    IMGUI_API bool          DataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* get_format, void* p_data_when_empty = NULL);
    ...
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* get_format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL);
